...
conditions = {
    'Vsg-Nsg-and': ['prefix', 'Vsg', 'det1sg', 'np1sg','and'],
    'Vpl-Nsg-and': ['prefix', 'Vpl', 'det1sg', 'np1sg','and'],
    'Vsg-Npl-and': ['prefix', 'Vsg', 'det1pl', 'np1pl','and'],
    'Vpl-Npl-and': ['prefix', 'Vpl', 'det1pl', 'np1pl','and'],
    'Vsg-Nsg-or': ['prefix', 'Vsg', 'det1sg', 'np1sg','or'],
    'Vpl-Nsg-or': ['prefix', 'Vpl', 'det1sg', 'np1sg','or'],
    'Vsg-Npl-or': ['prefix', 'Vsg', 'det1pl', 'np1pl','or'],
    'Vpl-Npl-or': ['prefix', 'Vpl', 'det1pl', 'np1pl','or'],
}
